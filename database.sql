...
BEGIN
    ...
    DECLARE statut_inscription VARCHAR(20);
...
BEGIN
    DECLARE prochaine_etape_id INT;
    DECLARE numero_etape_actuelle INT;
...
('admin', 'admin@consciencekongo.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'administrateur');